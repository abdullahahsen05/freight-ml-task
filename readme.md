...
- `index.html`: local dashboard for browsing deliverables and checks.
...
Then open <http://127.0.0.1:8000/> to review the dashboard, report, chart, predictions, and checklist.
